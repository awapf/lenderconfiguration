package ch.hypoplus.lender.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("lenderconfiguration");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("lenderconfiguration");
        ...
        config.getMapConfigs().put("ch.hypoplus.lender.domain.*", initializeDomainMapConfig(jHipsterProperties));
