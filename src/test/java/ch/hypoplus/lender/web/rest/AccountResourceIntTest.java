package ch.hypoplus.lender.web.rest;

import ch.hypoplus.lender.config.Constants;
import ch.hypoplus.lender.LenderconfigurationApp;
import ch.hypoplus.lender.domain.Authority;
import ch.hypoplus.lender.domain.User;
import ch.hypoplus.lender.repository.AuthorityRepository;
import ch.hypoplus.lender.repository.UserRepository;
import ch.hypoplus.lender.security.AuthoritiesConstants;
import ch.hypoplus.lender.service.MailService;
import ch.hypoplus.lender.service.dto.UserDTO;
import ch.hypoplus.lender.web.rest.errors.ExceptionTranslator;
import ch.hypoplus.lender.web.rest.vm.KeyAndPasswordVM;
import ch.hypoplus.lender.web.rest.vm.ManagedUserVM;
import ch.hypoplus.lender.service.UserService;
...
@SpringBootTest(classes = LenderconfigurationApp.class)
